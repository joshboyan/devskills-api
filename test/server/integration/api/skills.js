...
describe('./test/server/integration/skills', function() {

	context('/api/skill/:skill', function() {
	...
	context('/api/skill/:skill/latest route', function() {
	...
	context('/api/skill/:skill/average route', function() {
